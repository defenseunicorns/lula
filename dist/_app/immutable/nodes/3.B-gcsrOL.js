...
import { a as n, i as P, s as R } from '../chunks/Du6_yM1O.js';
import { s as U, g as q } from '../chunks/CXLXo5lt.js';
import { C as z, a as A, D as B } from '../chunks/BV0VOAYG.js';
import { s as b, c as E } from '../chunks/CD9Q30NH.js';
const F = () => {
		const s = U;
		return {
		...
		var $ = (e) => {
			...
			w = (e) => {
				var t = H(),
					...
					l = o(a),
					k = o(l);
				(B(k, { class: 'mx-auto h-16 w-16 mb-4' }), N(4), r(l), r(a), r(t), u(e, t));
			};
		P(C, (e) => {
			f() ? e($) : e(w, !1);
		});
