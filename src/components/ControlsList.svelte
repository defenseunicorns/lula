<script lang="ts">
  import { complianceStore, controls, families, filteredControls, selectedFamily, searchTerm, selectedControl } from '../stores/compliance';
    ...
    <div class="flex-1 overflow-auto">
      <div class="divide-y divide-gray-200 dark:divide-gray-700">
        {#each $filteredControls as control}
          ...
          <div 
            class="grid grid-cols-5 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 cursor-pointer transition-all duration-150 {$selectedControl?.id === control.id ? 'bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 shadow-sm' : ''}" 
